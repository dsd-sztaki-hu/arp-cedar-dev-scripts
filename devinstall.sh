...
echo '$CEDAR_BIOPORTAL_API_KEY_CONFIGURED_INPUT': $CEDAR_BIOPORTAL_API_KEY_CONFIGURED_INPUT
...
export CEDAR_BIOPORTAL_API_KEY_CONFIGURED=$CEDAR_BIOPORTAL_API_KEY_CONFIGURED_INPUT
